...
export const addHandlersSelection = (callback) => {
    ...
    const mouseup = (e) => {
        ...
        selectionRect.style.visibility = "visible";
        selectionRect.setAttribute("fill","blue");
        selectionRect.className = "selection-rect";
        
        console.log("root:", document.querySelector(".root"), "SelectionRect to append: ", selectionRect);
        // This should select the root g for the vega visualization
        document.querySelector(".mark-arc").appendChild(selectionRect);
       
        console.log("selection rect:\n", document.getElementsByClassName("selection-rect"))
